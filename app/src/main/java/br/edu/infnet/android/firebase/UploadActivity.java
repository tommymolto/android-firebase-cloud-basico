package br.edu.infnet.android.firebase;
...
public class UploadActivity extends RootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = storage.getReferenceFromUrl("gs://gec-2017.appspot.com/").child("firebase.png");
        ...
        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    //Upload to firebase
                    showProgressDialog("Subindo Bitmap", " com SPOILERS...");
                    ...
                    uploadTask.addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(UploadActivity.this, "Upload Falhou!", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            dismissProgressDialog();
                            Toast.makeText(UploadActivity.this, "Upload com sucesso!", Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        btnUploadFile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                storageReference = storage.getReferenceFromUrl("gs://gec-2017.appspot.com/").child("test_upload.txt");

                //Upload input stream to Firebase
                showProgressDialog("Upload File", "Subundo arquivo texto com SPOILERS...");
