    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnDownloadByteArray.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StorageReference storageRef = storage.getReferenceFromUrl("gs://gec-2017.appspot.com/").child("viserion.jpeg");
        ...
        btnDownloadAsFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //download the file
                try {
                    showProgressDialog("Download File", "Descendo arquivo...");
                    ...
                    storageRef.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                            ...
                            showToast("Download com sucesso!");
                        }
